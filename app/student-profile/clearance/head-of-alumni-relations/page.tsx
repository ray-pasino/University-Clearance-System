...
import {
    ...
    ChevronLeft,
    ChevronRight,
} from "lucide-react"; // Import Loader
    ...
    useEffect(() => {
        ...
        const fetchStudentData = async () => {
            try {
                ...
                // Populate formData with student data, except intakeYear and gradYear
                setFormData((prev) => ({
                    ...prev,
                    name: res.data.name || "",
                    dob: res.data.dob ? res.data.dob.split("T")[0] : "", // format ISO date to yyyy-mm-dd
                    gender: res.data.gender || "",
                    email: res.data.email || "",
                    country: res.data.country || "Ghana", // fallback to Ghana if not present
                    programme: res.data.programme || "",
                    category: res.data.category || "",
                    // intakeYear and gradYear left as empty strings to keep placeholders
                    intakeYear: "",
                    gradYear: "",
                }));
            } catch (err) {
                        ...
                        <div className="hidden header sm:flex items-center justify-center items-center mx-16 md:mx-38 xl:mx-30 mt-2">
                            ...
                            <div className="hidden profile-container text-gray-400 sm:flex mt-2  items-center">
                                ...
                                <div className="ml-2">
                                    ...
                                    <p className="text-[10px] sm:text-[8px]">{studentData?.email}</p>
                                </div>
                            </div>
                        </div>
