     ...
     <Link href="/">
      ...
      <div className="flex flex-col items-center justify-center">
        ...
        <form className="mt-6 mb-10 flex flex-col space-y-6 items-center justify-center"> 
            ...
            <input className="outline-none w-58 sm:w-78 md:w-82 lg:w-86 text-center border-1 border-blue-600 rounded-md px-6 py-2" type="text" placeholder="Staff ID"/>

            {/* input for password */}
            <div>
            <span className="w-58 sm:w-78 md:w-82 lg:w-86 flex justify-center items-center border-1 border-blue-600 rounded-md">
            <input className="outline-none w-[90%] text-center  px-6 py-2" type={`${seePassword ? 'text' : 'password'}`} placeholder="password"/>
            <EyeClosed size={16}  className={`${ seePassword ? 'text-gray-400' : 'text-black-800'} cursor-pointer`} onClick={handlePasswordVisibility}/>
            </span>
